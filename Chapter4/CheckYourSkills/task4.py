#create a game in which the computer selects a random word. Then the player has 5 chances to ask if any letter is contained in the word and to guess the password
import random
...
repeat = True
while repeat == True :
    programming = ['coding' 'machine learning', 'python', 'artificial intelligence', 'algorithm']
    basketball = ['lay up' 'match', 'ball', 'dunk', 'point guard']
    ...
    if word in programming:  # Give category of word
        print("Your word is related to programming.")
    elif word in basketball:
        print("Your word is related to basketball.")
